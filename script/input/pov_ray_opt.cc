...
double irram_sintan(double x1, double x2, double x3, double x4, double x5)
{
	REAL x1_real(x1);
	REAL x2_real(x2);
	REAL x3_real(x3);
...
void compute() {
	...
	std::string x1_str,x2_str,x3_str,x4_str,x5_str;
	iRRAM::cin >> x1_str >> x2_str >> x3_str >> x4_str >> x5_str;
	double x1_double = binary2double(x1_str);
	double x2_double = binary2double(x2_str);
	double x3_double = binary2double(x3_str);
	double x4_double = binary2double(x4_str);
	double x5_double = binary2double(x5_str);
	double r_double = irram_sintan(x1_double, x2_double, x3_double, x4_double, x5_double);
