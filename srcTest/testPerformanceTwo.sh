...
gcc testPerformanceTwo.o binary.o ${funcName}.o expr_${uniqueLabel}_mpfr.o -lm -lqd -lmpfr -o testPerformanceTwo_${uniqueLabel}.exe -O3
./testPerformanceTwo_${uniqueLabel}.exe ${resultFileName} ${x0Start} ${x0End} ${x1Start} ${x1End} > /dev/null
