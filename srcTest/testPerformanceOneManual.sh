...
gcc gccPerformanceTest.o binary.o ${funcName}.o -lmpfr -lm -lqd -o gccPerformanceTest_${uniqueLabel}.exe -O3
./gccPerformanceTest_${uniqueLabel}.exe ${resultFileName} ${start} ${end}
