...
struct errorInfo test3paramFPEDParallel(unsigned long int testNumX0, unsigned long int testNumX1, unsigned long int testNumX2, const char* uniqueLabel, const char* fileNameKernel, int myid, int i0StartLocal, int i0EndLocal, int i1StartLocal, int i1EndLocal, int i2StartLocal, int i2EndLocal, double x0startOriginInterval, double x1startOriginInterval, double x2startOriginInterval, double stepX0, double stepX1, double stepX2) {
...
int main_inner(const unsigned long int &testNumX0, const unsigned long int &testNumX1, const unsigned long int &testNumX2, const string &uniqueLabelStr, const string &fileNameKernelStr, const int &myid, const int &numProcs, const int &i0StartLocal, const int &i0EndLocal, const int &i1StartLocal, const int &i1EndLocal, const int &i2StartLocal, const int &i2EndLocal, const double &x0startOriginInterval, const double &x1startOriginInterval, const double &x2startOriginInterval, const double &stepX0, const double &stepX1, const double &stepX2)
{
    ...
    struct errorInfo err = test3paramFPEDParallel(testNumX0, testNumX1, testNumX2, uniqueLabel, fileNameKernel, myid, i0StartLocal, i0EndLocal, i1StartLocal, i1EndLocal, i2StartLocal, i2EndLocal, x0startOriginInterval, x1startOriginInterval, x2startOriginInterval, stepX0, stepX1, stepX2);
...
int main(int argc, char **argv) {
	...
	iRRAM::iRRAM_exec(main_inner, testNumX0, testNumX1, testNumX2, uniqueLabelStr, fileNameKernelStr, myid, numProcs, i0StartLocal, i0EndLocal, i1StartLocal, i1EndLocal, i2StartLocal, i2EndLocal, x0startOriginInterval, x1startOriginInterval, x2startOriginInterval, stepX0, stepX1, stepX2);
