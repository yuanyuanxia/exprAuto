...
void sample3paramX(DL xStart, DL xEnd, DL yStart, DL yEnd, DL zStart, DL zEnd, unsigned long int testNumX, unsigned long int testNumY, unsigned long int testNumZ, const char* uniqueLabel, const char *fileNameKernel, int myid, int iStartLocal, int iEndLocal)
{
    DL i, j, k;
    // DL maxInputX, maxInputY, maxInputZ, orcle, result;
    int ii, jj, kk;
    double x, y, z, reUlp, maxReUlp, lenX, lenY, lenZ;
    ...
    for(ii = iStartLocal; ii <= iEndLocal; ii++) {
        ...
        for(jj = 0; jj <= testNumY; jj++) {
            ...
            for(kk = 0; kk <= testNumZ; kk++) {
                ...
                z = k.d;
                computeResult3param(x, y, z, mpfrResult);
                computeOrcle3param(x, y, z, mpfrOrcle);
...
void sample3paramY(DL xStart, DL xEnd, DL yStart, DL yEnd, DL zStart, DL zEnd, unsigned long int testNumX, unsigned long int testNumY, unsigned long int testNumZ, const char* uniqueLabel, const char *fileNameKernel, int myid, int iStartLocal, int iEndLocal)
{
    DL i, j, k;
    // DL maxInputX, maxInputY, maxInputZ, orcle, result;
    int ii, jj, kk;
...
void sample3paramZ(DL xStart, DL xEnd, DL yStart, DL yEnd, DL zStart, DL zEnd, unsigned long int testNumX, unsigned long int testNumY, unsigned long int testNumZ, const char* uniqueLabel, const char *fileNameKernel, int myid, int iStartLocal, int iEndLocal)
{
    DL i, j, k;
    // DL maxInputX, maxInputY, maxInputZ, orcle, result;
    int ii, jj, kk;
...
int main(int argc, char *argv[])
{
    ...
    // parameters init
    DL xStart, xEnd, yStart, yEnd, zStart, zEnd;
    ...
    if(argc == 11) {
        ...
        drawNum = strtod(argv[7], NULL);
        findMaxNum = strtod(argv[8], NULL);
        strcpy(fileNameKernel, argv[9]);
        strcpy(uniqueLabel, argv[10]);
    } else {
        printf("Usage: ./sample3paramParallel.out xStart xEnd yStart yEnd zStart zEnd drawNum findMaxNum fileNameKernel uniqueLabel\n");
        exit(EXIT_FAILURE);
    }
    ...
    sample3paramX(xStart, xEnd, yStart, yEnd, zStart, zEnd, drawNum, findMaxNum, findMaxNum, uniqueLabel, fileNameKernel, myid, iStartLocal, iEndLocal);
    sample3paramY(xStart, xEnd, yStart, yEnd, zStart, zEnd, findMaxNum, drawNum, findMaxNum, uniqueLabel, fileNameKernel, myid, iStartLocal, iEndLocal);
    sample3paramZ(xStart, xEnd, yStart, yEnd, zStart, zEnd, findMaxNum, findMaxNum, drawNum, uniqueLabel, fileNameKernel, myid, iStartLocal, iEndLocal);
