...
struct errorInfo test2paramFPEDParallel(unsigned long int testNumX0, unsigned long int testNumX1, const char* uniqueLabel, const char *fileNameKernel, int myid, int i0StartLocal, int i0EndLocal, int i1StartLocal, int i1EndLocal, double x0startOriginInterval, double x1startOriginInterval, double stepX0, double stepX1)
{
...
int main_inner(const unsigned long int &testNumX0, const unsigned long int &testNumX1, const string &uniqueLabelStr, const string &fileNameKernelStr, const int &myid, const int &numProcs, const int &i0StartLocal, const int &i0EndLocal, const int &i1StartLocal, const int &i1EndLocal, const double &x0startOriginInterval, const double &x1startOriginInterval, const double &stepX0, const double &stepX1)
{
    ...
    struct errorInfo err = test2paramFPEDParallel(testNumX0, testNumX1, uniqueLabel, fileNameKernel, myid, i0StartLocal, i0EndLocal, i1StartLocal, i1EndLocal, x0startOriginInterval, x1startOriginInterval, stepX0, stepX1);
...
int main(int argc, char **argv)
{
	...
	iRRAM::iRRAM_exec(main_inner, testNumX0, testNumX1, uniqueLabelStr, fileNameKernelStr, myid, numProcs, i0StartLocal, i0EndLocal, i1StartLocal, i1EndLocal, x0startOriginInterval, x1startOriginInterval, stepX0, stepX1);
